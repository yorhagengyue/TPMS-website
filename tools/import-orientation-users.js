...
if (!process.env.DATABASE_URL) {
  ...
  console.error('Windows: set DATABASE_URL=postgresql://postgres:postgres@localhost:5432/tpms_db_pg');
  console.error('Linux/Mac: export DATABASE_URL=postgresql://postgres:postgres@localhost:5432/tpms_db_pg');
  process.exit(1);
}
